...
LOCAL_CFLAGS := -D_DEBUG=1 -Wall -Wno-unknown-pragmas -fopenmp -fexceptions -D__ANDROID_API_PLATFORM__="$(TARGET_PLATFORM)"
...
CBP2NDK_CMDLINE := --ratio 2 --rotate 90  -f OutBmp.bmz
